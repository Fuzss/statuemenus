...
public class ArmorStandPose {
    ...
    public static final ArmorStandPose ATHENA = new ArmorStandPose("athena").withBodyPose(new Rotations(0.0F,
                    0.0F,
                    2.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose BRANDISH = new ArmorStandPose("brandish").withBodyPose(new Rotations(0.0F,
                    0.0F,
                    -2.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose CANCAN = new ArmorStandPose("cancan").withBodyPose(new Rotations(0.0F,
                    22.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose DEFAULT = new ArmorStandPose("default").withLeftArmPose(new Rotations(-10.0F,
                    0.0F,
                    -10.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose ENTERTAIN = new ArmorStandPose("entertain").withHeadPose(new Rotations(-15.0F,
                    0.0F,
                    0.0F))
            ...
            .withRightLegPose(new Rotations(-5.0F, 3.0F, 3.0F))
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose HERO = new ArmorStandPose("hero").withBodyPose(new Rotations(0.0F, 8.0F, 0.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose HONOR = new ArmorStandPose("honor").withHeadPose(new Rotations(-15.0F,
                    0.0F,
                    0.0F))
            .withLeftArmPose(new Rotations(-110.0F, 35.0F, 0.0F))
            .withLeftLegPose(new Rotations(5.0F, -3.0F, -3.0F))
            ...
            .withRightLegPose(new Rotations(-5.0F, 3.0F, 3.0F))
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose RIPOSTE = new ArmorStandPose("riposte").withHeadPose(new Rotations(16.0F,
                    20.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose SALUTE = new ArmorStandPose("salute").withLeftArmPose(new Rotations(10.0F,
                    0.0F,
                    -5.0F))
            .withLeftLegPose(new Rotations(-1.0F, 0.0F, -1.0F))
            ...
            .withRightLegPose(new Rotations(1.0F, 0.0F, 1.0F))
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose SOLEMN = new ArmorStandPose("solemn").withBodyPose(new Rotations(0.0F,
                    0.0F,
                    2.0F))
            .withHeadPose(new Rotations(15.0F, 0.0F, 0.0F))
            ...
            .withRightLegPose(new Rotations(1.0F, 0.0F, 1.0F))
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose ZOMBIE = new ArmorStandPose("zombie").withHeadPose(new Rotations(-10.0F,
                    0.0F,
                    -5.0F))
            ...
            .withSourceType(SourceType.MINECRAFT);
    public static final ArmorStandPose WALKING = new ArmorStandPose("walking").withRightArmPose(new Rotations(20.0F,
                    0.0F,
                    10.0F))
            .withLeftArmPose(new Rotations(-20.0F, 0.0F, -10.0F))
            .withRightLegPose(new Rotations(-20.0F, 0.0F, 0.0F))
            .withLeftLegPose(new Rotations(20.0F, 0.0F, 0.0F))
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose RUNNING = new ArmorStandPose("running").withRightArmPose(new Rotations(-40.0F,
                    0.0F,
                    10.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose POINTING = new ArmorStandPose("pointing").withHeadPose(new Rotations(0.0F,
                    20.0F,
                    0.0F))
            .withRightArmPose(new Rotations(-90.0F, 18.0F, 0.0F))
            .withLeftArmPose(new Rotations(0.0F, 0.0F, -10.0F))
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose BLOCKING = new ArmorStandPose("blocking").withRightArmPose(new Rotations(-20.0F,
                    -20.0F,
                    0.0F))
            ...
            .withLeftLegPose(new Rotations(20.0F, 0.0F, 0.0F))
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose LUNGEING = new ArmorStandPose("lungeing").withBodyPose(new Rotations(15.0F,
                    0.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose WINNING = new ArmorStandPose("winning").withHeadPose(new Rotations(-15.0F,
                    0.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose SITTING = new ArmorStandPose("sitting").withRightArmPose(new Rotations(-80.0F,
                    20.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose ARABESQUE = new ArmorStandPose("arabesque").withHeadPose(new Rotations(-15.0F,
                    0.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose CUPID = new ArmorStandPose("cupid").withBodyPose(new Rotations(10.0F,
                    0.0F,
                    0.0F))
            ...
            .withLeftLegPose(new Rotations(75.0F, 0.0F, 0.0F))
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose CONFIDENT = new ArmorStandPose("confident").withHeadPose(new Rotations(-10.0F,
                    20.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose DEATH = new ArmorStandPose("death").withHeadPose(new Rotations(-85.0F,
                    0.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose FACEPALM = new ArmorStandPose("facepalm").withHeadPose(new Rotations(45.0F,
                    -4.0F,
                    1.0F))
            .withBodyPose(new Rotations(10.0F, 0.0F, 0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose LAZING = new ArmorStandPose("lazing").withHeadPose(new Rotations(14.0F,
                    -12.0F,
                    6.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose CONFUSED = new ArmorStandPose("confused").withHeadPose(new Rotations(0.0F,
                    30.0F,
                    0f))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose FORMAL = new ArmorStandPose("formal").withHeadPose(new Rotations(4.0F,
                    0.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose SAD = new ArmorStandPose("sad").withHeadPose(new Rotations(63.0F, 0.0F, 0.0F))
            .withBodyPose(new Rotations(10.0F, 0.0F, 0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose JOYOUS = new ArmorStandPose("joyous").withHeadPose(new Rotations(-11.0F,
                    0.0F,
                    0.0F))
            .withBodyPose(new Rotations(-4.0F, 0.0F, 0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    public static final ArmorStandPose STARGAZING = new ArmorStandPose("stargazing").withHeadPose(new Rotations(-22.0F,
                    25.0F,
                    0.0F))
            ...
            .withSourceType(SourceType.VANILLA_TWEAKS);
    private static final ArmorStandPose[] VALUES = {
            DEFAULT,
            SOLEMN,
            ATHENA,
            BRANDISH,
    ...
    private static final ArmorStandPose[] VALUES_FOR_RANDOM_SELECTION = {
            DEFAULT,
            SOLEMN,
            ATHENA,
            BRANDISH,
    ...
    public String getTranslationKey() {
        return this.name != null ? StatueMenus.MOD_ID + ".screen.pose." + this.name : null;
    }
    ...
    public ArmorStandPose withHeadPose(Rotations rotation) {
        return new ArmorStandPose(this.name,
                null,
                rotation,
                this.bodyPose,
                this.leftArmPose,
    ...
    public static ArmorStandPose randomize(PosePartMutator[] mutators, boolean clampRotations) {
        ...
        return new ArmorStandPose(null,
                null,
                mutators[0].randomRotations(clampRotations),
