...
public class LegacyArmorStandPosesScreen extends AbstractArmorStandScreen {
    ...
    public LegacyArmorStandPosesScreen(ArmorStandHolder holder, Inventory inventory, Component component, DataSyncHandler dataSyncHandler) {
